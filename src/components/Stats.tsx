    ...
    <div className="py-16 bg-gradient-to-b from-black to-purple-900/20">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            { icon: <TrendingUp className="w-8 h-8" />, label: "Market Cap", value: "$3.5M" },
            { icon: <Users className="w-8 h-8" />, label: "Holders", value: "68,791" },
            { icon: <Wallet className="w-8 h-8" />, label: "Total Supply", value: "1,000,000,000" },
          ].map((stat, index) => (
